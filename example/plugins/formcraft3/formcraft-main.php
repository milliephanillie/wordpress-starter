  ...
  */
  ...
  function formcraft3_redirect_to_form_page() {
    ...
    function formcraft3_admin_scripts() {
      ...
      if (function_exists('register_block_type') && function_exists('has_blocks') && has_blocks() && $screen->base === 'post') {
    ...
    function formcraft3_check()
    {
      ...
      if ( is_user_logged_in() && isset($_GET['formcraft3_export_all']) ) {
