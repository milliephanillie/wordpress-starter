	...
	<div class="inside eventon_settings_page">
		...
		<div class='evotrouble_right' style='text-align:center'>
			...
			<div class='evotrouble_documentation'>
				<h2 class='heading tac' style='text-align:center; padding-top:60px;'><?php _e('EventON Documentation','eventon');?></h2>			
			...
			<!-- video tutorials -->
				<a id='troubleshoot_videos' class='evo_admin_btn btn_prime'><?php _e('Video Tutorials on using EventON','eventon');?></a>
				<div class='troubleshoot_videos' style='display:none'>
					...
					<p>
						<a href="https://www.youtube.com/playlist?list=PLj0uAR9EylGrROSEOpT6WuL_ZkRgEIhLq" class='evo_admin_btn btn_prime' target="_blank"><?php _e('Rest of Video Tutorials','eventon');?></a>
					</p>
				</div>

			<div class='evotrouble_bottom' style='padding-top:60px; text-align:center'>
				<div class='evo_support_box evo_troubleshoot'>
					<h2><?php _e('Having issues with EventON? ','eventon');?><br/><a style='margin-top:8px; display:inline-block' class='evo_admin_btn' href='http://docs.myeventon.com/documentations/check-eventon-working/' target='_blank'><?php _e('Troubleshoot Guide to Eventon','eventon');?></a></h2>
				...
				<div class='evo_support_box special' >
					<h2><?php _e('Official Support Helpdesk','eventon');?><br/><a style='margin-top:8px; display:inline-block' class='evo_admin_btn' href='http://helpdesk.ashanjay.com' target='_blank'>EventON HelpDesk</a></h2>
					<p><?php _e('This is our official support system. Please feel free to search for already asked questions and ask your support questions for our help. EventON <b>Purchase code</b> is required to access helpdesk.','eventon');?></p>
				</div>				
