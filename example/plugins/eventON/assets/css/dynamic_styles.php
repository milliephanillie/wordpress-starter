 ...
 */
	...
	$style_array = apply_filters('eventon_inline_styles_array', array(
		...
		array(
			...
			'css'=>'color:#$', 'var'=>'evcal__fc6',	'default'=>$evo_color_1
		),array(
			'item'=>'#evcal_list .eventon_list_event .evoet_cx em a',
			'css'=>'color:#$', 'var'=>'evcal__fc7',	'default'=>$evo_color_1
		),
		...
		array(
			...
			'multicss'=>array(
				array('css'=>'color:#$', 'var'=>'evcal__ecI',	'default'=>$evo_color_2),
			...
			'css'=>'color:#$', 'var'=>'evcal__fc2',	'default'=>$evo_color_1
		),array(
		...
		,array(
			...
			'item'=>'.ajde_evcal_calendar #evcal_list.eventon_events_list .eventon_list_event p .evoet_cx span.evcal_event_title',
			'css'=>'color:#$', 'var'=>'evcal__fc3',	'default'=>$evo_color_1
		),array(
			...
			'css'=>'color:#$', 'var'=>'evcal__fc3st',	'default'=>$evo_color_1
		),array(
