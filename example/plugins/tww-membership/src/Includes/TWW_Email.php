...
class TWW_Email {
    public function __construct() {
        add_filter('retrieve_password_message', [$this, 'send_custom_retrieve_password_change_email'], 10, 2);
        add_filter('wp_mail_content_type', [$this, 'set_html_content_type']);
    }

    public function send_custom_retrieve_password_change_email($message, $args) {
