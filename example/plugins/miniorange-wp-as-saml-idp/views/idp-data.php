        ...
        <div class="mo-idp-table-layout mo-idp-center mo-idp-sp-width ">
					...
					echo ' <tr>
                                ...
                                <div class="mo-idp-table-btn-cstm mo-idp-metadata-prem-feature-btn">
                                    <a  href="' . esc_url( $license_url ) . '" class="mo-idp-upload-data-anchor" style="color:orange;"><img src="' . esc_url( MSI_URL ) . 'includes/images/star.png" style="width:1rem;">
                                    Premium Feature   
                                </div>
                                </td>
                            </tr>';
...
if ( ! $expired_cert ) {
	echo '<td style="width:60%;  padding: 1.6rem 1.6rem;">
							...
							echo '  <a  href="' . esc_url( $license_url ) . '" style="color:orange;" class="mo-idp-upload-data-anchor"><img src="' . esc_url( MSI_URL ) . 'includes/images/star.png" style="width:1rem;">';
