                                ...
                                <div class="asl-panel-inner">
                                    <div class="sl-filter-sec">
                                        <div class="asl-addr-search">
                                            <input value="<?php echo $default_addr ?>" id="sl-main-search" type="text" class="<?php echo $search_type_class ?> form-control" placeholder="<?php echo esc_attr__( 'Enter your location', 'asl_locator') ?>">
                                                ...
                                                <div class="aswth-btn hide">
                                                    <span class="aswth">
                                                        ...
                                                        <div class="aswth-text">
                                                            <div class="contentA"><?php echo esc_attr__('OPEN', 'asl_locator') ?></div>
                                                            <div class="contentB"><?php echo esc_attr__('ALL', 'asl_locator') ?></div>
                                                        </div>
                                                    </span>
                                                </div>
                                            </div>
