...
<style type="text/css">
  <?php echo $css_code; ?>
  .asl-p-cont .onoffswitch .onoffswitch-label .onoffswitch-switch:before {content: "<?php echo esc_attr__('OPEN', 'asl_locator') ?>" !important;}
  .asl-p-cont .onoffswitch .onoffswitch-label .onoffswitch-switch:after {content: "<?php echo esc_attr__('ALL', 'asl_locator') ?>" !important;}
                    ...
                    <div id="asl-list" class="asl-panel pol-md-5">
                      ...
                      <div class="asl-panel-inner">
                        <div class="top-title Num_of_store">
                          ...
                          <a class="back-button"><?php echo esc_attr__('Back', 'asl_locator') ?> <i class="icon-back"></i></a>
                        </div>
                        ...
                        <div class="map-image">
                            <div class="search_filter inside-map">
                              <div class="asl-search-box">
                                <input type="text" value="<?php echo $default_addr ?>" id="auto-complete-search" class="form-control <?php echo $search_type_class ?>" placeholder="<?php echo esc_attr__( 'Find A Store','asl_locator') ?>">
