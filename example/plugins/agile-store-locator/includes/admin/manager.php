...
class Manager extends Base {
  ...
  public function _enqueue_scripts($all_scripts  = true, $tag = 'jscript') {
    ...
    // Plugin Validation
    $this->localize_scripts( $this->AgileStoreLocator.'-'.$tag, 'ASL_REMOTE',  array('Com' => get_option('asl-compatible'),  'sl_lang' => $this->lang,  'LANG' => $langs, 'URL' => admin_url( 'admin-ajax.php' )));
