...
class Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'template',
			[
				'label' => __( 'Select Template', 'asl-admin' ),
				'type' => \Elementor\Controls_Manager::SELECT2,
				'default' => '0',
				'options' => array(
					'0' => esc_attr__('Template 0','asl-admin'),
					'1' => esc_attr__('Template 1','asl-admin'),
					'2' => esc_attr__('Template 2','asl-admin'),
					'3' => esc_attr__('Template 3','asl-admin'),
					'list' => esc_attr__('Template List','asl-admin'),
				),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '0',
				'options' => array(
					'0' => esc_attr__('Search By Address (Google)','asl-admin'),
					'1' => esc_attr__('Search By Store Name (Database)','asl-admin'),
					'2' => esc_attr__('Search By Stores Cities, States (Database)','asl-admin'),
					'3' => esc_attr__('Geocoding on Enter key (Google Geocoding API)','asl-admin'),
				),
			]
		);
		...
		$this->add_control(
			'layout',
			[
				'label' => __( 'Select Layout', 'asl-admin' ),
				'type' => \Elementor\Controls_Manager::SELECT2,
				'default' => '0',
				'options' => array(
					'0' => esc_attr__('List Format','asl-admin'),
					'1' => esc_attr__('Accordion (States, Cities, Countries)','asl-admin'),
					'2' => esc_attr__('Accordion (Categories)','asl-admin'),
				),
			]
		);
		...
		$this->add_control(
			'distance_control',
			[
				'label' => esc_html__( 'Distance Control', 'asl-admin' ),
				'type' => \Elementor\Controls_Manager::SELECT2,
				'default' => '0',
				'options' => [
					'0' => esc_html__( 'Slider', 'asl-admin' ),
					'1' => esc_html__( 'Dropdown', 'asl-admin' ),
					'2' => esc_html__( 'Boundary Box', 'asl-admin' ),
				],
		...
		$this->add_control(
			'head_title',
			[
				'label' => esc_html__( 'Head Title', 'asl-admin' ),
