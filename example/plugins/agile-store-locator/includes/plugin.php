	...
	public function add_admin_menu() {
		...
		if (current_user_can(ASL_PERMISSION)) {
			...
			if(!$level_mode) {
				...
				add_submenu_page( 'asl-plugin', esc_attr__('Manage Specialities','asl_locator'), esc_attr__('Manage Specialities','asl_locator'), ASL_PERMISSION, 'manage-asl-specials', array($this->plugin_admin, 'page_manage_specials'));
				add_submenu_page( 'asl-plugin', esc_attr__('Manage Brands','asl_locator'), esc_attr__('Manage Brands','asl_locator'), ASL_PERMISSION, 'manage-asl-filter', array($this->plugin_admin,'page_manage_attribute'));
			}
