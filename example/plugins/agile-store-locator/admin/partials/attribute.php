          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-12 ralign" style="margin-bottom: 15px">
                ...
                <button type="button" id="btn-asl-new-attr" class="btn btn-success mrg-r-10"><i><svg width="13" height="13"><use xlink:href="#i-plus"></use></svg></i><?php echo esc_attr__('New Brand','asl_locator') ?></button>
              </div>
            </div>
