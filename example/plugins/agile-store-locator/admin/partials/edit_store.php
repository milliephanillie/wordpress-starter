                            ...
                            <div id="sl-other-details" class="tab-pane p-0">
                              <div class="row">
                                ...
                                <div class="col-md-6 form-group sl-complx mb-3">
                                  <label for="txt_special"><?php echo esc_attr__('Special','asl_locator') ?></label>
                                  <select name="ddl_special"  id="ddl_special" multiple class="asl-chosen chosen-select-width form-control">                      
                                    <?php foreach($specials as $special): ?>
                                      <option  <?php foreach($store_special as $s_special ) if($s_special == $special->id) echo 'selected="selected" '; ?> value="<?php echo esc_attr($special->id) ?>"><?php echo esc_attr($special->name) ?></option>
                                    <?php endforeach ?>
                                  </select>
                                </div>
                                <div class="col-md-6 form-group sl-complx mb-3">
                                  <label for="txt_brand"><?php echo esc_attr__('Brand','asl_locator') ?></label>
                                  <select name="ddl_brand"  id="ddl_brand" multiple class="asl-chosen chosen-select-width form-control">                      
                                    <?php foreach($brands as $brand): ?>
                                      <option  <?php foreach($store_brand as $s_brand ) if($s_brand == $brand->id) echo 'selected="selected" '; ?> value="<?php echo esc_attr($brand->id) ?>"><?php echo esc_attr($brand->name) ?></option>
                                    <?php endforeach ?>
                                  </select>
                                </div>
                                <div class="col-md-6 form-group sl-complx mb-3">
